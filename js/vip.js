$(function(){
  ...
  function picLoop() {
      var num = $('.banner-pic>div').length;
      var timer = null;
      var index = 0;
      $('.banner-pic>div').first().clone().appendTo('.banner-pic');
      $('.banner-pic').width($('.banner-pic>div').width()*(num+1));  
      function next(){
        index++;
        if (index==num+1) {
          index=1;
        ...
        $('.banner-pic').stop().animate({left:-356*index+'px'},500);
    ...
    $(".img-thumb li").mouseover(function(){
      ...
      $('.banner-pic').css('left',-356*now+'px');
